...
import { ArrowUpRight, Award, Zap, Briefcase, CheckCircle, Upload, Target } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-950 text-gray-100 relative overflow-hidden">
      ...
      <nav className="relative flex justify-between items-center py-6 px-8 md:px-16 border-b border-gray-800">
        ...
        <div className="hidden md:flex space-x-8 items-center">
          ...
          <button className="px-5 py-2 bg-gray-900 rounded-md border border-gray-800 font-medium text-gray-300 hover:bg-gray-800 hover:border-cyan-900 transition">
            Log in
          </button>
          <button className="px-5 py-2 bg-gradient-to-r from-blue-800 to-blue-900 rounded-md font-medium text-white hover:from-blue-700 hover:to-blue-800 transition shadow-md shadow-blue-900/50 border border-blue-700">
            Sign up
          </button>
        </div>
      ...
      <div className="relative px-8 md:px-16 py-20 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
            AI <span className="text-cyan-400">Supercharges</span> Your Career Journey
          </h1>
          <p className="mt-6 text-lg text-gray-400 max-w-lg">
            AIRecruit harnesses cutting-edge AI to transform your job search experience. Our system analyzes your resume with precision, identifies improvement opportunities, and connects you with ideal job matches. Watch your interview callback rate increase by 300% as our algorithms align your unique talents with employers seeking exactly what you offer.
          </p>
          <div className="mt-8 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            >
              ...
              Upload Resume Now
              <ArrowUpRight className={`ml-2 transition-transform duration-300 ${isHovering ? 'translate-x-1 -translate-y-1' : ''}`} />
            </button>
            <button className="px-8 py-4 bg-black bg-opacity-50 rounded-md font-semibold text-gray-300 border border-gray-800 hover:border-blue-900 hover:bg-black hover:bg-opacity-80 transition">
              Watch Demo
            </button>
          </div>
          ...
          <div className="w-full h-96 bg-black bg-opacity-50 rounded-md backdrop-blur-sm flex items-center justify-center border border-gray-800 relative overflow-hidden">
            ...
            <div className="relative bg-black bg-opacity-70 p-8 rounded-md border border-gray-800 shadow-xl backdrop-blur-sm">
              <div className="flex justify-between items-center mb-6">
                <div className="text-xl font-semibold text-cyan-400">Resume Analysis</div>
                <div className="text-xs bg-blue-900/30 px-2 py-1 rounded border border-blue-800 text-blue-400">SCANNING</div>
              </div>
      ...
      <div className="px-8 md:px-16 py-20">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-bold">Unlock Your Career Potential</h2>
          <p className="mt-4 text-gray-500">Our AI-powered platform offers three game-changing benefits</p>
        </div>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-black bg-opacity-40 p-8 rounded-md border border-gray-800 hover:border-blue-800 transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/10 relative overflow-hidden group">
            ...
            <h3 className="text-xl font-bold mb-3 text-cyan-400">Resume Score & Analysis</h3>
            <p className="text-gray-400">Get an instant score and detailed feedback on your resume's strengths and weaknesses. Our AI identifies key improvement areas and provides actionable suggestions to make your resume stand out.</p>
          ...
          <div className="bg-black bg-opacity-40 p-8 rounded-md border border-gray-800 hover:border-blue-800 transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/10 relative overflow-hidden group">
            ...
            <h3 className="text-xl font-bold mb-3 text-cyan-400">AI Resume Enhancement</h3>
            <p className="text-gray-400">Let our AI transform your resume with optimized keywords, improved phrasing, and tailored content that passes through Applicant Tracking Systems and impresses human recruiters.</p>
            <div className="mt-6 inline-block text-sm font-medium text-blue-400">
          ...
          <div className="bg-black bg-opacity-40 p-8 rounded-md border border-gray-800 hover:border-blue-800 transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/10 relative overflow-hidden group">
            ...
            <h3 className="text-xl font-bold mb-3 text-cyan-400">Smart Job Matching</h3>
            <p className="text-gray-400">Discover perfect job opportunities matched to your skills, experience, and career goals. Our algorithm analyzes thousands of openings to find positions where you're most likely to succeed.</p>
            <div className="mt-6 inline-block text-sm font-medium text-blue-400">
      ...
      <div className="px-8 md:px-16 py-12">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="bg-black bg-opacity-40 p-6 rounded-md border border-gray-800">
            ...
            <div className="text-gray-500 text-sm">Increase in Interview Rate</div>
          </div>
          <div className="bg-black bg-opacity-40 p-6 rounded-md border border-gray-800">
      ...
      <div className="px-8 md:px-16 py-20">
        <div className="max-w-4xl mx-auto bg-black bg-opacity-40 p-12 rounded-md border border-gray-800 relative overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-blue-500 rounded-full opacity-50 animate-ping" style={{animationDuration: '3s'}}></div>
            <div className="absolute top-2/3 left-1/3 w-2 h-2 bg-blue-500 rounded-full opacity-50 animate-ping" style={{animationDuration: '4s'}}></div>
            <div className="absolute top-1/2 left-2/3 w-2 h-2 bg-blue-500 rounded-full opacity-50 animate-ping" style={{animationDuration: '5s'}}></div>
            <div className="absolute top-3/4 left-3/4 w-2 h-2 bg-blue-500 rounded-full opacity-50 animate-ping" style={{animationDuration: '2.5s'}}></div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center relative">
            <div className="md:w-2/3">
              ...
              <h2 className="text-3xl font-bold">Ready to Level Up Your Job Search?</h2>
              <p className="mt-4 text-gray-400">Upload your resume now and get instant AI-powered insights. Join thousands of professionals who've already boosted their career prospects.</p>
              <div className="mt-6 flex items-center">
                <div className="flex -space-x-2 mr-4">
                  {[1, 2, 3, 4].map(i => (
                    <div key={i} className="w-8 h-8 rounded-full bg-gray-900 border-2 border-gray-800"></div>
                  ))}
                </div>
                <div className="text-sm text-gray-500">10,000+ players already leveling up</div>
              </div>
            </div>
      ...
      <footer className="bg-black bg-opacity-60 py-12 px-8 md:px-16 border-t border-gray-900">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4 text-cyan-400">AIRecruit</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-500">
              ...
              <li><a href="#" className="hover:text-cyan-400 transition">Resume Tips</a></li>
              <li><a href="#" className="hover:text-cyan-400 transition">Career Advice</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-md bg-gray-900 flex items-center justify-center text-gray-500 border border-gray-800 hover:bg-blue-900/30 hover:text-white hover:border-blue-800 transition">
                <span>FB</span>
              </a>
              <a href="#" className="w-10 h-10 rounded-md bg-gray-900 flex items-center justify-center text-gray-500 border border-gray-800 hover:bg-blue-900/30 hover:text-white hover:border-blue-800 transition">
                <span>TW</span>
